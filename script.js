document.addEventListener("DOMContentLoaded", () => {
  ...
  function loadDefaultData() {
    ...
    jsonInput.value = JSON.stringify(defaultData, null, 2); // Pretty print JSON
          ...
          <div class="biomarker-warraper pillers-wrapper">
              ...
              ${
                pillarsData.introduction
                  ? `<p>${handleMarkup(pillarsData.introduction)}</p>`
                  : ""
              }
...
<div class="pillar-seciton-two">
  ...
  function renderSupplementsPreview() {
    pdfPreview.innerHTML = "<h1>Supplement & Action Plan</h1>";
  }
